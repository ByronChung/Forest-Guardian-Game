To play our game demo, extract everything from the zip folder then run "4483 Game.exe" in the 
build folder

Our game is a platformer shooter game, where you venture through the woods encountering monsters
